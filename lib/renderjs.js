...
/***/ function(module, exports, __webpack_require__) {
	...
	var MeSwipeTrigger = __webpack_require__(172);
	var MeVPads = __webpack_require__(175);
	var MeArticle = __webpack_require__(176);
		...
		var MePage = React.createClass({
			...
			render: function () {
				return React.createElement(
					"div",
					{ className: "me-page", id: this.props.page_id, style: this.props.normalStyle },
					this.props.children
				);
			} });
		return MePage;
...
/***/ function(module, exports, __webpack_require__) {
		...
		var PadBuffer = React.createClass({
			...
			render: function () {
				...
				if (pageInstance != null) return React.createElement(
					"div",
					{ id: this.props.id, className: className, style: css },
					pageInstance
				);else return React.createElement("div", { id: this.props.id, className: className, style: css });
			}
		});
	 ...
	 **/
		var MeHammer = function (hammer, default_handler) {
			...
			this.listeners = {};
			this.hammer.on("swipeleft swiperight swipeup swipedown", function (evt) {
				self.handleSwipe(evt);
			});
		};
		...
		var MeVPads = React.createClass({
			...
			handleTouchEnd: function (evt) {
				if (Math.abs(this.lastDeltaX) > this.props.pageWidth / 2) {
					if (this.lastDeltaX < 0) this.moveNext();else this.movePrev();
				}
			},
			...
			render: function () {
				...
				return React.createElement(
					Hammer,
					{ ref: this._registerHammer, id: "oper-area", className: "magazine-page-container show" },
					React.createElement(
						"div",
						null,
						React.createElement(
